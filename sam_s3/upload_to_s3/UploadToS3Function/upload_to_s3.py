...
def lambda_handler(event, context):
    ...
    try:
        ...
        # Extract reqId and fullName from the request body
        request_body = json.loads(event['body'])
        req_id = request_body.get('ReqId', '')
        full_name = request_body.get('FullName', '')
        
        # Construct new file name using reqId and fullName
        new_file_name = f"{req_id}_{full_name}_{file_name}"
